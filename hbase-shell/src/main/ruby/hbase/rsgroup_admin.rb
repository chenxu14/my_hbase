...
module Hbase
  class RSGroupAdmin
    ...
    #--------------------------------------------------------------------------
    # refresh groups
    def refresh_group_servers
      @admin.refreshGroupServers
    end

    #--------------------------------------------------------------------------
    # move table to group
    def move_table_to_group(table, group_name)
      @admin.moveTableToGroup(org.apache.hadoop.hbase.TableName.valueOf(table), group_name)
    end

    #--------------------------------------------------------------------------
    # move server to group
    def move_server_to_group(server, group_name)
      @admin.moveServerToGroup(org.apache.hadoop.hbase.net.Address.fromString(server), group_name)
    end
