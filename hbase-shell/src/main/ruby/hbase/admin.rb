...
module Hbase
  class Admin
    ...
    def compact(table_or_region_name, family = nil, type = "NORMAL", date = nil)
      family_bytes = nil
      unless family.nil?
      ...
      begin
        ...
        @admin.compact(TableName.valueOf(table_or_region_name), family_bytes, false, compact_type, date)
      end
    end
    ...
    def hcd(arg, htd)
      ...
      family.setPrefetchHFileMaxSize(JLong.valueOf(arg.delete(org.apache.hadoop.hbase.HColumnDescriptor::PREFETCH_HFILE_MAXSIZE))) if arg.include?(org.apache.hadoop.hbase.HColumnDescriptor::PREFETCH_HFILE_MAXSIZE)
