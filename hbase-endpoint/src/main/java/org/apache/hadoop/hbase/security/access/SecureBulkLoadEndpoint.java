...
public class SecureBulkLoadEndpoint extends SecureBulkLoadService
  ...
  public void secureBulkLoadHFiles(RpcController controller,
    ...
    if(userToken != null) {
      ...
      CoprocessorRpcUtils.setControllerException(controller, new DoNotRetryIOException("User token cannot be null"));
        ...
        loaded = ugi.doAs(new PrivilegedAction<Boolean>() {
          ...
          public Boolean run() {
            ...
            try {
              ...
              return env.getRegion().bulkLoadHFiles(familyPaths, true, request.getSkipWal(),
