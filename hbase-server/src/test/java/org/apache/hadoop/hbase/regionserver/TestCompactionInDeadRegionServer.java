...
public class TestCompactionInDeadRegionServer {
  ...
  public void setUp() throws Exception {
    UTIL.getConfiguration().setClass(WALFactory.WAL_PROVIDER, AsyncFSWALProvider.class, WALProvider.class);
    UTIL.getConfiguration().setInt(HConstants.ZK_SESSION_TIMEOUT, 2000);
    UTIL.getConfiguration().setInt("hbase.regionserver.hlog.sync.timeout", 10000);
  ...
  public void test() throws Exception {
    ...
    watcher.getRecoverableZooKeeper().delete(
      ZKUtil.joinZNode(watcher.rsZNode, rsToSuspend.getServerName().toString()),
      -1);
