...
public class TestStoreFile extends HBaseTestCase {
  ...
  public void testReference() throws IOException {
    ...
    hsf.initReader();
    StoreFile.Reader reader = hsf.getReader();
  ...
  public void testEmptyStoreFileRestrictKeyRanges() throws Exception {
    ...
    StoreFileScanner scanner =
        StoreFileScanner.newInstance(reader, mock(HFileScanner.class), false, false, 0, 0, true);
    Scan scan = new Scan();
  ...
  private void bloomWriteRead(StoreFile.Writer writer, FileSystem fs) throws Exception {
    ...
    StoreFile.Reader reader =
        new StoreFile.Reader(fs, f, cacheConf, true, new AtomicInteger(0), true, conf);
    reader.loadFileInfo();
  ...
  public void testCacheOnWriteEvictOnClose() throws Exception {
    ...
    hsf.initReader();
    StoreFile.Reader readerOne = hsf.getReader();
    ...
    hsf.initReader();
    StoreFile.Reader readerTwo = hsf.getReader();
