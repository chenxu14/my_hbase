...
import org.apache.hadoop.hbase.io.encoding.BufferedDataBlockEncoder.OffheapDecodedExtendedCell;
...
public class TestBufferedDataBlockEncoder {
  ...
  public void testKVCodecWithTagsForDecodedCellsWithNoTags() throws Exception {
    ...
    OffheapDecodedExtendedCell c3 = new OffheapDecodedExtendedCell(ByteBuffer.wrap(kv2.getKey()),
