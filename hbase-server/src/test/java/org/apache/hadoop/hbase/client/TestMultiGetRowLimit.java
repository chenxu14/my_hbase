...
public class TestMultiGetRowLimit {
  ...
  public static void setUpBeforeClass() throws Exception {
    TEST_UTIL.getConfiguration().setBoolean(HConstants.RS_PARALLEL_GET_ENABLED, true);
    TEST_UTIL.getConfiguration().setLong(HConstants.RS_PARALLEL_GET_THREADS, 3);
    TEST_UTIL.getConfiguration().setLong(HConstants.RS_MAXROWS_PER_MULTIGET, ROWS / 2);
