    ...
    try {
      ...
      OutputCollector<ImmutableBytesWritable, Result> outputCollector =
        ...
        public void collect(ImmutableBytesWritable arg, Result result) throws IOException {
          assertArrayEquals(org.apache.hadoop.hbase.shaded.com.google.common.primitives.Bytes.concat(firstPartKeyValue, bSeparator,
      ...
      assertArrayEquals(org.apache.hadoop.hbase.shaded.com.google.common.primitives.Bytes.concat(firstPartValue,
