...
public class TestPartialResultsFromClientSide {
  ...
  private long getCellHeapSize() throws Exception {
    if (CELL_HEAP_SIZE == -1) {
      ...
      CELL_HEAP_SIZE = CellUtil.estimatedSizeOfCell(result.rawCells()[0])
          - (ClassSize.ARRAY+3);
  ...
  public void testBatchingResultWhenRegionMove() throws IOException {
    ...
    Table table = createTestTable(TableName.valueOf("testBatchingResultWhenRegionMove"), ROWS, FAMILIES,
        QUALIFIERS, VALUE);
