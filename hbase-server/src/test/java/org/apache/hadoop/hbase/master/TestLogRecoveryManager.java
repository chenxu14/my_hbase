...
import org.apache.hadoop.hbase.master.LogRecoveryManager.TaskBatch;
...
public abstract class TestLogRecoveryManager {
  protected static final Log LOG = LogFactory.getLog(TestLogRecoveryManager.class);
  protected final ServerName DUMMY_MASTER = ServerName.valueOf("dummy-master,1,1");
  protected final ServerManager sm = Mockito.mock(ServerManager.class);
  protected final MasterServices master = Mockito.mock(MasterServices.class);
  static {
    Logger.getLogger("org.apache.hadoop.hbase").setLevel(Level.DEBUG);
  }
  protected ZooKeeperWatcher zkw;
  protected DummyServer ds;
  private static boolean stopped = false;
  protected LogRecoveryManager slm;
  protected Configuration conf;
  protected int to;
  protected RecoveryMode mode;
  ...
  protected void waitForCounter(final AtomicLong ctr, long oldval, long newval, long timems)
      throws Exception {
    Expr e = new Expr() {
      @Override
      public long eval() {
  ...
  protected void waitForCounter(final Expr e, final long oldval, long newval, long timems)
      throws Exception {
