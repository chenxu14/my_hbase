...
public abstract class TestSplitLogWorker {
  protected static final Log LOG = LogFactory.getLog(TestSplitLogWorker.class);
  ...
  protected abstract SplitLogWorker getSplitLogWorker(RegionServerServices mockedRS);
