...
public class TestScannerHeartbeatMessages {
  ...
  public void testScannerHeartbeatMessages() throws Exception {
    ...
    testImportanceOfHeartbeats(testHeartbeatWithSparseRowFilter());
    testImportanceOfHeartbeats(testHeartbeatWithSparseCellFilter());
  }
  ...
  public static class SparseRowFilter extends FilterBase {
    ...
    public boolean filterRowKey(byte[] buffer, int offset, int length) throws IOException {
      ...
      byte[] target = ROWS[NUM_ROWS - 1];
      return !Bytes.equals(buffer, offset, length, target, 0, target.length);
    }
   ...
   * @throws Exception
   */
  public Callable<Void> testHeartbeatWithSparseCellFilter() throws Exception {
    return new Callable<Void>() {
      @Override
      public Void call() throws Exception {
        Scan scan = new Scan();
   ...
   * @throws Exception
   */
  public Callable<Void> testHeartbeatWithSparseRowFilter() throws Exception {
    return new Callable<Void>() {
    	@Override
      public Void call() throws Exception {
        Scan scan = new Scan();
