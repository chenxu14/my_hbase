...
public class TestFanOutOneBlockAsyncDFSOutput {
  ...
  public static void setUp() throws Exception {
    ...
    TEST_UTIL.getConfiguration().setInt(AbstractFSWAL.WAL_SYNC_TIMEOUT, READ_TIMEOUT_MS);
  ...
  public void test() throws IOException, InterruptedException, ExecutionException {
    ...
    final FanOutOneBlockAsyncDFSOutput out = FanOutOneBlockAsyncDFSOutputHelper.createOutput(FS, f, null,
  ...
  public void testWriteLargeChunk() throws IOException, InterruptedException, ExecutionException {
    ...
    final byte[] b = new byte[50 * 1024 * 1024];
    ThreadLocalRandom.current().nextBytes(b);
    out.write(b);
    out.flush(false);
