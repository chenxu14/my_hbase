...
public class TestTableLockManager {
  ...
  public static class TestLockTimeoutExceptionMasterObserver implements MasterObserver {
    @Override
  ...
  public static class TestAlterAndDisableMasterObserver implements MasterObserver {
    @Override
    public void preAddColumnFamilyHandler(ObserverContext<MasterCoprocessorEnvironment> ctx,
        TableName tableName, HColumnDescriptor columnFamily) throws IOException {
