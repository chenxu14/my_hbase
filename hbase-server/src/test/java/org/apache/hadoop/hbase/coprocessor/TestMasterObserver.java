...
public class TestMasterObserver {
  ...
  public static class CPMasterObserver implements MasterObserver {
    ...
    @Override
    public void postBalanceRSGroup(ObserverContext<MasterCoprocessorEnvironment> ctx, String groupName,
        boolean balancerRan) throws IOException {
    }

    @Override
    public void preRefreshGroupServers(ObserverContext<MasterCoprocessorEnvironment> ctx) 
        throws IOException {
    }

    @Override
    public void postRefreshGroupServers(ObserverContext<MasterCoprocessorEnvironment> ctx) 
        throws IOException {
    }
    ...
    @Override
    public void postMoveTableToGroup(ObserverContext<MasterCoprocessorEnvironment> ctx, TableName tableName,
        String groupName) throws IOException {
    }
  }
