...
public class StoreFileInfo {
   ...
   */
  public StoreFile.Reader open(FileSystem fs, CacheConfig cacheConf, boolean canUseDropBehind,
    ...
    if (reader == null) {
      if (this.reference != null) {
        ...
        reader = new StoreFile.Reader(fs, status.getPath(), in, length, cacheConf,
            isPrimaryReplicaStoreFile, refCount, shared, conf);
      }
    }
    if (this.coprocessorHost != null) {
