...
public abstract class AbstractProtobufLogWriter {
  ...
  public void init(FileSystem fs, Path path, Path oldPath, Configuration conf, boolean overwritable)
      throws IOException {
    this.conf = conf;
  ...
  protected abstract void initOutput(FileSystem fs, Path path, Path oldPath, boolean overwritable, int bufferSize,
