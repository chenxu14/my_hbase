...
public class StoreScanner extends NonReversedNonLazyKeyValueScanner
  ...
  protected void seekScanners(List<? extends KeyValueScanner> scanners,
    ...
    if (LOG.isDebugEnabled()) {
      String targetRow = Bytes.toString(seekKey.getRowArray(), seekKey.getRowOffset(), seekKey.getRowLength());
      long duration = System.currentTimeMillis() - startTime;
      StringBuilder msg = new StringBuilder("seek to target row (").append(targetRow)
          .append("), duration (").append(duration).append("ms),")
          .append(" isLazy: ").append(isLazy)
          .append(", isParallelSeek: ").append(isParallelSeek)
          .append(", scannersSize: ").append(scanners.size());
      ...
      switch(qcode) {
        ...
        case INCLUDE_AND_SEEK_NEXT_COL:
          ...
          if (this.countPerRow > storeOffset) {
            ...
            scannerContext.incrementSizeProgress(cellSize, CellUtil.estimatedSizeOfCell(cell));
