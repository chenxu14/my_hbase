...
public class HBaseSaslRpcServer {
  ...
  public HBaseSaslRpcServer(AuthMethod method, SecretManager<TokenIdentifier> secretManager) throws IOException {
    switch (method) {
      case DIGEST:
        ...
        saslServer = Sasl.createSaslServer(AuthMethod.DIGEST.getMechanismName(), null,
          SaslUtil.SASL_DEFAULT_REALM, SaslUtil.SASL_PROPS, new SaslDigestCallbackHandler(secretManager));
        break;
      case KERBEROS:
