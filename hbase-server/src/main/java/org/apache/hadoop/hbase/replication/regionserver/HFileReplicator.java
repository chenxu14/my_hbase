...
public class HFileReplicator {
  ...
  public void replicate(ThreadPoolExecutor pool) throws IOException {
    ...
    LOG.debug("copy HFiles to staging dir successfully.");
      ...
      public void run() {
        ...
        for (Entry<String, Path> tableStagingDir : tableStagingDirsMap.entrySet()) {
          ...
          try {
            ...
            LOG.error("Failed to initialize LoadIncrementalHFiles for table "
                + tableNameString, e);
            continue;
          }
          ...
          try (RegionLocator locator = connection.getRegionLocator(tableName)) {
            table = HFileReplicator.this.connection.getTable(tableName);
            ...
            // Set the staging directory which will be used by LoadIncrementalHFiles for loading the data
        ...
        LOG.debug("do bulkload hfile successfully.");
      }    	
    });
  }
