...
public class ReaderContext {
  ...
  private final boolean skipPrefetch;

  public ReaderContext(Path filePath, FSDataInputStreamWrapper fsdis, long fileSize,
      HFileSystem hfs, boolean primaryReplicaReader, ReaderType type, boolean skipPrefetch) {
    ...
    this.type = type;
    this.skipPrefetch = skipPrefetch;
  }
  ...
  public boolean skipPrefetch() {
    return this.skipPrefetch;
  }
}
