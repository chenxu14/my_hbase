...
class BucketEntry implements HBaseReferenceCounted {
  ...
  protected void setDeserializerReference(CacheableDeserializer<Cacheable> deserializer) {
  ...
  <T> T withWriteLock(IdReadWriteLock offsetLock, BucketEntryHandler<T> handler) {
