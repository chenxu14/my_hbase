...
public class WALUtil {
  ...
  public static WALKey writeFlushMarker(WAL wal, NavigableMap<byte[], Integer> replicationScope,
      HRegionInfo hri, final FlushDescriptor f, boolean sync, MultiVersionConcurrencyControl mvcc)
          throws IOException {
    WALKey walKey = doFullMarkerAppendTransaction(wal, replicationScope, hri,
  ...
  public static WALKey writeRegionEventMarker(WAL wal,
    NavigableMap<byte[], Integer> replicationScope, HRegionInfo hri, RegionEventDescriptor r,
   ...
   */
  private static WALKey doFullMarkerAppendTransaction(final WAL wal,
    final NavigableMap<byte[], Integer> replicationScope, final HRegionInfo hri, final WALEdit edit,
    final MultiVersionConcurrencyControl mvcc, final boolean sync) throws IOException {
