...
public interface RpcCallContext {
   ...
   */
  default String getRequestUserName() {
    return getRequestUser() == null ? null : getRequestUser().getShortName();
  }
  ...
  boolean isAboveQuota(long maxQuotaResultSize, long maxRowsPerMultiGet);
}
