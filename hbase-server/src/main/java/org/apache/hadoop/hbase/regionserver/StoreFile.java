...
public class StoreFile {
  ...
  private Reader createStreamReader(boolean canUseDropBehind) throws IOException {
    initReader();
    Reader reader = fileInfo.open(this.fs, this.cacheConf, canUseDropBehind, -1L,
  ...
  public static class Reader {
    ...
    private Reader(HFile.Reader reader, AtomicInteger refCount, boolean shared) {
      this.reader = reader;
    ...
    public StoreFileScanner getStoreFileScanner(boolean cacheBlocks, boolean pread,
      ...
      return StoreFileScanner.newInstance(this, getScanner(cacheBlocks, pread, isCompaction),
