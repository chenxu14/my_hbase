...
public class MasterRpcServices extends RSRpcServices
  ...
  private CompactRegionResponse compactMob(final CompactRegionRequest request,
    ...
    if (!master.getAssignmentManager().getTableStateManager().isTableState(tableName, ZooKeeperProtos.Table.State.ENABLED)) {
    ...
    master.requestMobCompaction(tableName, compactedColumns, allFiles, request.getDate());
