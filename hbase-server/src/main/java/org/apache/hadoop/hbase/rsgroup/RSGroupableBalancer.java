...
public interface RSGroupableBalancer extends LoadBalancer {
  ...
  String HBASE_RSGROUP_BULK_BALANCE = "hbase.rsgroup.bulk.balance";
  String HBASE_RSGROUP_LOADBALANCER_SPECIAL_GROUPS = "hbase.rsgroup.loadbalancer.specialgroups";
  String HBASE_RSGROUP_LOADBALANCER_EXCLUDE = "hbase.rsgroup.loadbalancer.exclude";
}
