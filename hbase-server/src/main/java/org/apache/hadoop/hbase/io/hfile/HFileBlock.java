...
public class HFileBlock implements Cacheable {
    ...
    public BlockIterator blockRange(final long startOffset,
      ...
      return new BlockIterator() {
        ...
        public HFileBlock nextBlock() throws IOException {
          ...
          length = b.nextBlockOnDiskSizeWithHeader;
  ...
  static class FSReaderImpl extends AbstractFSReader {
    ...
    throws IOException {
      ...
      ByteBuffer headerBuf = (prefetchedHeader != null && prefetchedHeader.offset == offset) ? prefetchedHeader.buf: null;
      ...
      if (LOG.isTraceEnabled()) {
        LOG.trace("Read " + b + " in " + duration + " ms");  
      }
