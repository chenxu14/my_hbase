...
public class HFileWriterImpl implements HFileWriter {
  ...
  public void beforeShipped() throws IOException {
    ...
    if (this.lastCell != null && ByteBufferExtendedCell.class.isAssignableFrom(lastCell.getClass())) {
      this.lastCell = KeyValueUtil.toNewKeyCell(this.lastCell);
    }
    if (this.firstCellInBlock != null
        && ByteBufferExtendedCell.class.isAssignableFrom(firstCellInBlock.getClass())) {
      this.firstCellInBlock = KeyValueUtil.toNewKeyCell(this.firstCellInBlock);
    }
    if (this.lastCellOfPreviousBlock != null
        && ByteBufferExtendedCell.class.isAssignableFrom(lastCellOfPreviousBlock.getClass())) {
