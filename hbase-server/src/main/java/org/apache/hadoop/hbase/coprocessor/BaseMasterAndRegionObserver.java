...
public abstract class BaseMasterAndRegionObserver extends BaseRegionObserver
  ...
  @Override
  public void preRefreshGroupServers(final ObserverContext<MasterCoprocessorEnvironment> ctx) 
      throws IOException {
  }

  @Override
  public void postRefreshGroupServers(final ObserverContext<MasterCoprocessorEnvironment> ctx) 
      throws IOException {
  }
