...
public class ReaderContextBuilder {
  ...
  public ReaderContextBuilder withSkipPrefetch(boolean pefetchNoNeed) {
  ...
  public ReaderContext build() {
    validateFields();
    return new ReaderContext(filePath, fsdis, fileSize, hfs, primaryReplicaReader, type, pefetchNoNeed);
  }
