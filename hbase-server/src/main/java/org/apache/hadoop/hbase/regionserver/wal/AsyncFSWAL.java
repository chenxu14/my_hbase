...
public class AsyncFSWAL extends AbstractFSWAL<AsyncWriter> {
  ...
  @Override
  protected long append(HRegionInfo hri, WALKey key, WALEdit edits, boolean inMemstore) throws IOException {
  ...
  private void waitForSafePoint() {
    ...
    try {
      ...
      epochAndState = currentEpochAndState | 1; // wait for rolling?
