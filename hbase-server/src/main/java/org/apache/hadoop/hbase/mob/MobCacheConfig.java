...
public class MobCacheConfig extends CacheConfig {
  ...
  public MobCacheConfig(Configuration conf, HColumnDescriptor family, ByteBuffAllocator allocator) {
    super(conf, family, allocator);
    instantiateMobFileCache(conf);
  }

  public MobCacheConfig(Configuration conf, ByteBuffAllocator allocator) {
    super(conf, allocator);
    instantiateMobFileCache(conf);
  }
