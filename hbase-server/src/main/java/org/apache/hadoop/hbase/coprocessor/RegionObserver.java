...
public interface RegionObserver extends Coprocessor {
   ...
   * @throws IOException if an error occurred on the coprocessor
   */
  default InternalScanner preFlush(final ObserverContext<RegionCoprocessorEnvironment> c, final Store store,
   ...
   * @param c the environment provided by the region server
   * @throws IOException if an error occurred on the coprocessor
   * @deprecated use {@link #postFlush(ObserverContext, Store, InternalScanner)} instead.
   */
  default void postFlush(final ObserverContext<RegionCoprocessorEnvironment> c) throws IOException {}
   ...
   */
  @Deprecated
  default InternalScanner preCompactScannerOpen(final ObserverContext<RegionCoprocessorEnvironment> c,
   ...
   * @throws IOException
   */
  default void preSplitAfterPONR(final ObserverContext<RegionCoprocessorEnvironment> ctx) throws IOException {}
   ...
   * @throws IOException
   */
  default void preRollBackSplit(final ObserverContext<RegionCoprocessorEnvironment> ctx) throws IOException {}
 ...
 * @throws IOException
 */
  default void prePrepareTimeStampForDeleteVersion(final ObserverContext<RegionCoprocessorEnvironment> c,
   ...
   * @throws IOException if an error occurred on the coprocessor
   */
  default boolean preCheckAndDeleteAfterRowLock(final ObserverContext<RegionCoprocessorEnvironment> c,
      final byte[] row, final byte[] family, final byte[] qualifier, final CompareOp compareOp,
   ...
   */
  @Deprecated
  default void preWALRestore(final ObserverContext<RegionCoprocessorEnvironment> ctx,
   ...
   * @throws IOException
   */
  default StoreFile.Reader preStoreFileReaderOpen(final ObserverContext<RegionCoprocessorEnvironment> ctx,
   ...
   * @throws IOException
   */
  default StoreFile.Reader postStoreFileReaderOpen(final ObserverContext<RegionCoprocessorEnvironment> ctx,
      final FileSystem fs, final Path p, final FSDataInputStreamWrapper in, long size,
      final CacheConfig cacheConf, final Reference r, StoreFile.Reader reader) throws IOException {
    return reader;
  }
