...
public class DefaultStoreFlusher extends StoreFlusher {
  ...
  public DefaultStoreFlusher(Configuration conf, Store store) throws IOException{
    super(conf, store);
  }
  ...
  public List<Path> flushSnapshot(MemStoreSnapshot snapshot, long cacheFlushId,
    ...
    try {
      ...
      synchronized (flushLock) {
        ...
        boolean includesTags = (store instanceof HMobStore) ? true : snapshot.isTagsPresent();
