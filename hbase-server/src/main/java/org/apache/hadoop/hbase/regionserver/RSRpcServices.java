    ...
    try {
      ...
      if (rows > 0) {
        ...
        try {
            ...
            try {
              ...
              synchronized(scanner) {
                ...
                if (allowHeartbeatMessages && (scannerLeaseTimeoutPeriod > 0 || rpcTimeout > 0)) {
                  ...
                  if(LOG.isDebugEnabled()) {
                    LOG.debug("timeLimitDelta is " + timeLimitDelta);
                  }
                }
          ...
          // if large query(such as phoenix orderby) happend, tell the client don't retry
          if (e instanceof CoprocessorException) {
            throw e;
          }
