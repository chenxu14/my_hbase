...
public class RowCounter {
  ...
  throws IOException {
    ...
    Scan scan = new Scan();
    scan.setAttribute("hbase.mob.scan.raw", Bytes.toBytes(true));
    scan.setAttribute("hbase.mob.cache.blocks", Bytes.toBytes(false));
    scan.setAttribute("empty.value.on.mobcell.miss", Bytes.toBytes(true));
