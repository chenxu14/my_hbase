...
public interface RegionServerObserver extends Coprocessor {
   ...
   * @throws IOException
   */
  default void postMerge(final ObserverContext<RegionServerCoprocessorEnvironment> c,
   ...
   */
  default void preRollWALWriterRequest(final ObserverContext<RegionServerCoprocessorEnvironment> ctx)
      throws IOException {}
   ...
   * @throws IOException Signals that an I/O exception has occurred.
   */
  default void postRollWALWriterRequest(final ObserverContext<RegionServerCoprocessorEnvironment> ctx)
      throws IOException {}
   ...
   * @throws IOException Signals that an I/O exception has occurred.
   */
  default void postReplicateLogEntries(final ObserverContext<RegionServerCoprocessorEnvironment> ctx,
      List<WALEntry> entries, CellScanner cells) throws IOException {}
}
