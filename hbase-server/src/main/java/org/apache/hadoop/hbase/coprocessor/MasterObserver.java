...
public interface MasterObserver extends Coprocessor {
  ...
  void preRefreshGroupServers(final ObserverContext<MasterCoprocessorEnvironment> ctx) throws IOException;

  void postRefreshGroupServers(final ObserverContext<MasterCoprocessorEnvironment> ctx) throws IOException;

  void preMoveTableToGroup(final ObserverContext<MasterCoprocessorEnvironment> ctx, 
      final TableName tableName, final String groupName) throws IOException;

  void postMoveTableToGroup(final ObserverContext<MasterCoprocessorEnvironment> ctx, 
      final TableName tableName, final String groupName) throws IOException;
}
