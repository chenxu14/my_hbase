...
public interface MasterObserver extends Coprocessor {
   ...
   * @param columnFamily the HColumnDescriptor
   */
  default void preAddColumnFamilyHandler(
      final ObserverContext<MasterCoprocessorEnvironment> ctx,
      TableName tableName, HColumnDescriptor columnFamily) throws IOException {}
   ...
   * @param columnFamily the HColumnDescriptor
   */
  default void postAddColumnFamilyHandler(
      final ObserverContext<MasterCoprocessorEnvironment> ctx,
      TableName tableName, HColumnDescriptor columnFamily) throws IOException {}
   ...
   * @param columnFamily the HColumnDescriptor
   */
  default void preModifyColumnFamilyHandler(
      final ObserverContext<MasterCoprocessorEnvironment> ctx,
      TableName tableName, HColumnDescriptor columnFamily) throws IOException {}
   ...
   * @param columnFamily the HColumnDescriptor
   */
  default void postModifyColumnFamilyHandler(
      final ObserverContext<MasterCoprocessorEnvironment> ctx,
      TableName tableName, HColumnDescriptor columnFamily) throws IOException{}
   ...
   * @param columnFamily the column family
   */
  default void preDeleteColumnFamilyHandler(
      final ObserverContext<MasterCoprocessorEnvironment> ctx,
      final TableName tableName, final byte[] columnFamily) throws IOException {}
   ...
   * @param columnFamily the column family
   */
  default void postDeleteColumnFamilyHandler(
      final ObserverContext<MasterCoprocessorEnvironment> ctx,
      final TableName tableName, final byte[] columnFamily) throws IOException {}
   ...
   * @throws IOException
   */
  public default void preAbortProcedure(
   ...
   * @param ctx the environment to interact with the framework and master
   */
  public default void postAbortProcedure(ObserverContext<MasterCoprocessorEnvironment> ctx)
      throws IOException {}
  ...
  default void preRefreshGroupServers(final ObserverContext<MasterCoprocessorEnvironment> ctx) throws IOException {}

  default void postRefreshGroupServers(final ObserverContext<MasterCoprocessorEnvironment> ctx) throws IOException {}

  default void preMoveTableToGroup(final ObserverContext<MasterCoprocessorEnvironment> ctx, 
      final TableName tableName, final String groupName) throws IOException {}

  default void postMoveTableToGroup(final ObserverContext<MasterCoprocessorEnvironment> ctx, 
      final TableName tableName, final String groupName) throws IOException {}
}
