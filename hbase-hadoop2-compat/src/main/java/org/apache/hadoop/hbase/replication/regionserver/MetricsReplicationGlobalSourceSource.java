...
public class MetricsReplicationGlobalSourceSource implements MetricsReplicationSourceSource{
  ...
  public MetricsReplicationGlobalSourceSource(MetricsReplicationSourceImpl rms) {
    ...
    shippedHFilesCounter = rms.getMetricsRegistry().getCounter(SOURCE_LOG_READ_IN_BYTES, 0L);
    sizeOfHFileRefsQueueGauge = rms.getMetricsRegistry().getGauge(SOURCE_SIZE_OF_HFILE_REFS_QUEUE, 0L);
