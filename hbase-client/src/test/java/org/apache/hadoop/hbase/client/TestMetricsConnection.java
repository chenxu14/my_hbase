...
public class TestMetricsConnection {
  ...
  public void testStaticMetrics() throws IOException {
    ...
    for (MetricsConnection.CallTracker t : new MetricsConnection.CallTracker[] {
      ...
      Assert.assertEquals("Failed to invoke callTimer on " + t, loop, t.callTimers.elements().nextElement().count());
      Assert.assertEquals("Failed to invoke reqHist on " + t, loop, t.reqHists.elements().nextElement().count());
      Assert.assertEquals("Failed to invoke respHist on " + t, loop, t.respHists.elements().nextElement().count());
    }
  }
}
