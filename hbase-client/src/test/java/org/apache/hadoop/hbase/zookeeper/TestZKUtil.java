...
public class TestZKUtil {
  ...
  public void testCreateACL() throws ZooKeeperConnectionException, IOException {
    ...
    Assert.assertTrue(!aclList.contains(new ACL(Perms.ALL, new Id("sasl", "@group1")))
        && !aclList.contains(new ACL(Perms.ALL, new Id("sasl", "@group2"))));
    Assert.assertTrue(aclList.contains(new ACL(Perms.ALL, new Id("sasl", "user1")))
        && aclList.contains(new ACL(Perms.ALL, new Id("sasl", "user2")))
        && aclList.contains(new ACL(Perms.ALL, new Id("sasl", "user3"))));
  }
