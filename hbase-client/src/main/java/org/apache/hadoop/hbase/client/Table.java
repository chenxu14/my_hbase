...
public interface Table extends Closeable {
   ...
   * @throws IOException e
   */
  boolean[] existsAll(List<? extends Get> gets) throws IOException;
   ...
   * @since 0.90.0
   */
  Result[] get(List<? extends Get> gets) throws IOException;
   ...
   * @since 0.20.0
   */
  void put(List<? extends Put> puts) throws IOException;
   ...
   * @since 0.20.1
   */
  void delete(List<? extends Delete> deletes) throws IOException;
