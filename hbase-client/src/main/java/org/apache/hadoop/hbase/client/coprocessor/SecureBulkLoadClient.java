...
public class SecureBulkLoadClient {
  ...
  public SecureBulkLoadClient(Table table, boolean skipWal) {
    this.table = table;
  ...
  public String prepareBulkLoad(final TableName tableName) throws IOException {
    try {
      ...
      CoprocessorRpcUtils.BlockingRpcCallback<SecureBulkLoadProtos.PrepareBulkLoadResponse> rpcCallback =
          new CoprocessorRpcUtils.BlockingRpcCallback<SecureBulkLoadProtos.PrepareBulkLoadResponse>();
  ...
  public void cleanupBulkLoad(final String bulkToken) throws IOException {
    try {
      ...
      CoprocessorRpcUtils.BlockingRpcCallback<SecureBulkLoadProtos.CleanupBulkLoadResponse> rpcCallback =
          new CoprocessorRpcUtils.BlockingRpcCallback<SecureBulkLoadProtos.CleanupBulkLoadResponse>();
