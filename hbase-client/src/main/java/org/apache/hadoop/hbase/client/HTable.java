...
public class HTable implements HTableInterface, RegionLocator {
   ...
   */
  @Override
  public void delete(final List<? extends Delete> deletes)
  throws IOException {
   ...
   */
  @Override
  public void put(final List<? extends Put> puts) throws IOException {
   ...
   */
  @Override
  public boolean[] existsAll(final List<? extends Get> gets) throws IOException {
