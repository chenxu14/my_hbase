...
public class HBaseAdmin implements Admin {
  ...
  private Future<Void> createTableAsyncV2(final HTableDescriptor desc, final byte[][] splitKeys)
    ...
    String targetGroup = conf.get("hbase.createtable.rsgroup", "none");
    if (!"none".equalsIgnoreCase(targetGroup)) {
      desc.setValue(HTableDescriptor.GROUP_NAME, targetGroup);
    }
    String targetStorage = conf.get("hbase.createtable.dngroup", "none");
    if (!"none".equalsIgnoreCase(targetStorage)) {
      for (HColumnDescriptor cfDesc : desc.getColumnFamilies()) {
        cfDesc.setStoragePolicy(targetStorage);
      }
    }
  ...
  public void truncateTable(final TableName tableName, final boolean preserveSplits)
      throws IOException {
    executeCallable(new MasterCallable<TruncateTableResponse>(getConnection(), getRpcControllerFactory()) {
      @Override
  ...
  throws IOException {
    executeCallable(new MasterCallable<AddColumnResponse>(getConnection(), getRpcControllerFactory()) {
      @Override
  ...
  throws IOException {
    executeCallable(new MasterCallable<DeleteColumnResponse>(getConnection(), getRpcControllerFactory()) {
      @Override
  ...
  throws IOException {
    executeCallable(new MasterCallable<ModifyColumnResponse>(getConnection(), getRpcControllerFactory()) {
      @Override
  ...
  public void compact(final TableName tableName)
    throws IOException {
    compact(tableName, null, false, CompactType.NORMAL, null);
  }
  ...
  throws IOException {
    try {
      ...
      compact(TableName.valueOf(tableNameOrRegionName), null, false, CompactType.NORMAL, null);
    }
  }
  ...
  public void compact(final TableName tableName, final byte[] columnFamily)
    throws IOException {
    compact(tableName, columnFamily, false, CompactType.NORMAL, null);
  }
  ...
  throws IOException {
    try {
      ...
      compact(TableName.valueOf(tableNameOrRegionName), columnFamily, false, CompactType.NORMAL, null);
    }
  }
  ...
  throws IOException, InterruptedException {
    for (HRegionInfo region : getOnlineRegions(sn)) {
      compact(sn, region, major, null, null);
    }
  }
  ...
  throws IOException {
    compact(tableName, null, true, CompactType.NORMAL, null);
  }
  ...
  throws IOException {
    try {
      ...
      compact(TableName.valueOf(tableNameOrRegionName), null, true, CompactType.NORMAL, null);
    }
  }
  ...
  throws IOException {
    compact(tableName, columnFamily, true, CompactType.NORMAL, null);
  }
  ...
  throws IOException {
    try {
      ...
      // Invalid region, try table
      compact(TableName.valueOf(tableNameOrRegionName), columnFamily, true, CompactType.NORMAL, null);
    }
  }
  ...
  private void compact(final TableName tableName, final byte[] columnFamily,final boolean major,
      CompactType compactType, String date) throws IOException {
    switch (compactType) {
      case MOB:
        ServerName master = getMasterAddress();
        compact(master, getMobRegionInfo(tableName), major, columnFamily, date);
        break;
      case NORMAL:
      default:
        ...
        try {
          ...
          if (TableName.META_TABLE_NAME.equals(tableName)) {
            ...
            pairs = MetaTableAccessor.getTableRegionsAndLocations(zookeeper, connection, tableName);
          }
          for (Pair<HRegionInfo, ServerName> pair: pairs) {
            if (pair.getFirst().isOffline()) continue;
            if (pair.getSecond() == null) continue;
            try {
              compact(pair.getSecond(), pair.getFirst(), major, columnFamily, date);
  ...
  private ServerName getMasterAddress() throws IOException {
    ...
    HConnectionImplementation connection = (HConnectionImplementation)this.connection;
  ...
  throws IOException {
    ...
    compact(regionServerPair.getSecond(), regionServerPair.getFirst(), major, columnFamily, null);
  }

  private void compact(final ServerName sn, final HRegionInfo hri,
      final boolean major, final byte [] family, String date)
  throws IOException {
    PayloadCarryingRpcController controller = rpcControllerFactory.newController();
    AdminService.BlockingInterface admin = this.connection.getAdmin(sn);
    CompactRegionRequest request =
      RequestConverter.buildCompactRegionRequest(hri.getRegionName(), major, family, date);
    try {
      // TODO: this does not do retries, it should. Set priority and timeout in controller
  ...
  public boolean balancer() throws IOException {
    return executeCallable(new MasterCallable<Boolean>(getConnection(), getRpcControllerFactory()) {
      @Override
      protected Boolean rpcCall() throws Exception {
        return master.balance(getRpcController(), RequestConverter.buildBalanceRequest()).getBalancerRan();
      }
    });
  }
    ...
    executeCallable(new MasterCallable<Void>(getConnection(), getRpcControllerFactory()) {
      ...
      protected Void rpcCall() throws Exception {
        try {
          ...
          master.dispatchMergingRegions(getRpcController(), request);
        } catch (DeserializationException de) {
          LOG.error("Could not parse destination server name: " + de);
        }
        return null;
  ...
  public ClusterStatus getClusterStatus() throws IOException {
    return executeCallable(new MasterCallable<ClusterStatus>(getConnection(), getRpcControllerFactory()) {
      @Override
      protected ClusterStatus rpcCall() throws Exception {
        ...
        return ClusterStatus.convert(master.getClusterStatus(getRpcController(), req).getClusterStatus());
      }
    });
  }
  ...
  public void createNamespace(final NamespaceDescriptor descriptor) throws IOException {
    executeCallable(new MasterCallable<Void>(getConnection(), getRpcControllerFactory()) {
      ...
      protected Void rpcCall() throws Exception {
        ...
        master.createNamespace(getRpcController(),
  ...
  public void modifyNamespace(final NamespaceDescriptor descriptor) throws IOException {
    executeCallable(new MasterCallable<Void>(getConnection(), getRpcControllerFactory()) {
      @Override
      protected Void rpcCall() throws Exception {
        master.modifyNamespace(getRpcController(), ModifyNamespaceRequest.newBuilder().
  ...
  public void deleteNamespace(final String name) throws IOException {
    executeCallable(new MasterCallable<Void>(getConnection(), getRpcControllerFactory()) {
      @Override
      protected Void rpcCall() throws Exception {
        master.deleteNamespace(getRpcController(), DeleteNamespaceRequest.newBuilder().
  ...
  public NamespaceDescriptor getNamespaceDescriptor(final String name) throws IOException {
    return
        executeCallable(new MasterCallable<NamespaceDescriptor>(getConnection(), getRpcControllerFactory()) {
          @Override
          protected NamespaceDescriptor rpcCall() throws Exception {
            return ProtobufUtil.toNamespaceDescriptor(
              master.getNamespaceDescriptor(getRpcController(), GetNamespaceDescriptorRequest.newBuilder().
  ...
  public ProcedureInfo[] listProcedures() throws IOException {
    return
        executeCallable(new MasterCallable<ProcedureInfo[]>(getConnection(), getRpcControllerFactory()) {
          @Override
  ...
  public HTableDescriptor[] listTableDescriptorsByNamespace(final String name) throws IOException {
    return
        executeCallable(new MasterCallable<HTableDescriptor[]>(getConnection(), getRpcControllerFactory()) {
          @Override
          protected HTableDescriptor[] rpcCall() throws Exception {
  ...
  public TableName[] listTableNamesByNamespace(final String name) throws IOException {
    return
        executeCallable(new MasterCallable<TableName[]>(getConnection(), getRpcControllerFactory()) {
          @Override
          protected TableName[] rpcCall() throws Exception {
  ...
  public SnapshotResponse takeSnapshotAsync(SnapshotDescription snapshot) throws IOException,
    ...
    return executeCallable(new MasterCallable<SnapshotResponse>(getConnection(), getRpcControllerFactory()) {
      @Override
      public SnapshotResponse rpcCall() throws Exception {
  ...
  public boolean isSnapshotFinished(final SnapshotDescription snapshot)
    ...
    return executeCallable(new MasterCallable<IsSnapshotDoneResponse>(getConnection(), getRpcControllerFactory()) {
      @Override
      public IsSnapshotDoneResponse rpcCall() throws Exception {
  ...
  private void internalRestoreSnapshot(final String snapshotName, final TableName
    ...
    while (!done.getDone()) {
      ...
      LOG.debug("Getting current status of snapshot restore from master...");
          ...
          getConnection(), getRpcControllerFactory()) {
        @Override
        protected IsRestoreSnapshotDoneResponse rpcCall() throws Exception {
          return master.isRestoreSnapshotDone(getRpcController(), request);
        }
      });
    }
    if (!done.getDone()) {
  ...
  private RestoreSnapshotResponse internalRestoreSnapshotAsync(final SnapshotDescription snapshot)
    ...
    return executeCallable(new MasterCallable<RestoreSnapshotResponse>(getConnection(), getRpcControllerFactory()) {
      @Override
  ...
  public List<SnapshotDescription> listSnapshots() throws IOException {
    return executeCallable(new MasterCallable<List<SnapshotDescription>>(getConnection(), getRpcControllerFactory()) {
      ...
      protected List<SnapshotDescription> rpcCall() throws Exception {
        return master.getCompletedSnapshots(getRpcController(),
  ...
  public void compact(TableName tableName, CompactType compactType) throws IOException, InterruptedException {
    compact(tableName, null, false, compactType, null);
  }

  @Override
  public void compact(TableName tableName, byte[] columnFamily, CompactType compactType)
    throws IOException, InterruptedException {
    compact(tableName, columnFamily, false, compactType, null);
  }

  @Override
  public void compact(TableName tableName, byte[] columnFamily, CompactType compactType, String date)
    throws IOException, InterruptedException {
    compact(tableName, columnFamily, false, compactType, date);
  }

  @Override
  public void majorCompact(TableName tableName, CompactType compactType) throws IOException, InterruptedException {
    compact(tableName, null, true, compactType, null);
  }

  @Override
  public void majorCompact(TableName tableName, byte[] columnFamily, CompactType compactType)
    throws IOException, InterruptedException {
    compact(tableName, columnFamily, true, compactType, null);	
  }
