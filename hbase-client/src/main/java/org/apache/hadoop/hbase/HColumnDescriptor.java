...
public class HColumnDescriptor implements Comparable<HColumnDescriptor> {
  ...
  public static final String PREFETCH_HFILE_MAXSIZE = "PREFETCH_HFILE_MAXSIZE";
  ...
  public static final long DEFAULT_PREFETCH_HFILE_MAXSIZE = Long.MAX_VALUE;
  ...
  static {
    ...
    DEFAULT_VALUES.put(PREFETCH_HFILE_MAXSIZE, String.valueOf(DEFAULT_PREFETCH_HFILE_MAXSIZE));
  ...
  */
  ...
  /**
   * hfile bigger than the return value will bypass prefetch operation
   */
  public long getPrefetchHFileMaxSize() {
    String value = getValue(PREFETCH_HFILE_MAXSIZE);
    return value != null ? Long.parseLong(value) : Long.MAX_VALUE;
  }

  /**
   * hfile bigger than this value will bypass prefetch operation
   */
  public HColumnDescriptor setPrefetchHFileMaxSize(long value) {
    return setValue(PREFETCH_HFILE_MAXSIZE, Long.toString(value));
  }
  ...
  public ColumnFamilySchema convert() {
    ColumnFamilySchema.Builder builder = ColumnFamilySchema.newBuilder();
    builder.setName(UnsafeByteOperations.unsafeWrap(getName()));
