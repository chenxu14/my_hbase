...
public final class TableName implements Comparable<TableName> {
  ...
  public static byte [] isLegalFullyQualifiedTableName(final byte[] tableName) {
    ...
    int namespaceDelimIndex = org.apache.hadoop.hbase.shaded.com.google.common.primitives.Bytes.lastIndexOf(tableName,
  ...
  public static TableName valueOf(byte[] fullName) throws IllegalArgumentException{
    ...
    int namespaceDelimIndex = org.apache.hadoop.hbase.shaded.com.google.common.primitives.Bytes.lastIndexOf(fullName,
        (byte) NAMESPACE_DELIM);
