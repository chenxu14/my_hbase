...
public class TestByteBufferKeyValue {
  ...
  public void testCompare() {
    ...
    assertTrue(CellComparator.COMPARATOR.compare(cell1, cell2) < 0);
    Cell cell3 = getOffheapCell(row1, Bytes.toBytes("wide_family"), qual2);
    assertTrue(CellComparator.COMPARATOR.compare(cell1, cell3) < 0);
    Cell cell4 = getOffheapCell(row1, Bytes.toBytes("f"), qual2);
    assertTrue(CellComparator.COMPARATOR.compare(cell1, cell4) > 0);
